...
def obtener_detalles_cobro():
    r = requests.get(settings.PATH_CRONOGRAMAS + f"/cronogramas-cursos/detalles/",
                     headers={"Accept": "application/json"})
    if r.status_code != 200:
        print(
...
def generar_recibos_cobro_hasta_actualidad():
    ...
    for estudiante in estudiantes:
        ...
        for mes_nombre, mes_num in MESES:
            ...
            print("detalles cobro del estudiante con id " +
                  estudiante["id"] + " y mes " + mes_nombre + " encontrados, son de tamaño: " + str(len(detalles_cobro)))
